...
void CGameView::OnMButtonDown(UINT nFlags, CPoint point) {
	game_framework::CGame::Instance()->OnMButtonDown(nFlags, point);
	CView::OnMButtonDown(nFlags, point);
}
BOOL CGameView::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt) {
	game_framework::CGame::Instance()->OnMouseWheel(nFlags, zDelta, pt);
